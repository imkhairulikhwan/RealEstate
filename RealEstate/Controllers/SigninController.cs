...
namespace RealEstate.Controllers
{
    public class SigninController : Controller
    {
		...
		public SigninController(UserManager<ApplicationUser> userManager,SignInManager<ApplicationUser> signInManager, ILogger<SigninController> logger)
		{
		...
		public IActionResult ExternalLogin(string provider, string returnUrl = null)
		{
			...
			var redirectUrl = Url.Action(nameof(ExternalLoginCallback), "Signin", new { returnUrl });
